...
# initialize elasticsearch client w/ the selected cluster and authentication
def init_es_client(cluster_urls):
    username = input("Enter your Elasticsearch username: ")
    password = input("Enter your Elasticsearch password: ")
    return Elasticsearch(cluster_urls, http_auth=(username, password), verify_certs=False, timeout=30)
